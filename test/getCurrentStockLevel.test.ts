...
describe("getCurrentStockLevel returns correct stock level for existing SKU", () => {
  it("should return { sku: 'LTV719449/39/39', qty: 8510 } for getCurrentStockLevel('LTV719449/39/39')", async () => {
  ...
  it("should return { sku: 'HGG795032/35/91', qty: -30 } for getCurrentStockLevel('HGG795032/35/91')", async () => {
  ...
  it("should return { sku: 'CLQ274846/07/46', qty: -45 } for getCurrentStockLevel('CLQ274846/07/46') for stock qty 0", async () => {
  ...
  it("should return { sku: 'SXB930757/87/87', qty: 3552 } for getCurrentStockLevel('SXB930757/87/87') for 0 transactions", async () => {
